...
export interface CompanyDAOInterface extends utils.Interface {
  functions: {
    ...
    "executeProposal(uint256,address[],uint256[],bytes[],bytes32)": FunctionFragment;
    ...
    "i_votingDelay()": FunctionFragment;
    "i_votingPeriod()": FunctionFragment;
  ...
  encodeFunctionData(
    functionFragment: "i_votingDelay",
    values?: undefined
  ): string;
  encodeFunctionData(
    functionFragment: "i_votingPeriod",
    values?: undefined
  ): string;
...
export interface CompanyDAO extends BaseContract {
  ...
  functions: {
    ...
    i_votingDelay(overrides?: CallOverrides): Promise<[BigNumber]>;

    i_votingPeriod(overrides?: CallOverrides): Promise<[BigNumber]>;
  ...
  populateTransaction: {
    ...
    i_votingDelay(overrides?: CallOverrides): Promise<PopulatedTransaction>;

    i_votingPeriod(overrides?: CallOverrides): Promise<PopulatedTransaction>;
